...
function VideoPreview({ onVideoClick, searchTitle, videos: providedVideos }) {
    ...
    const videosToDisplay = providedVideos ?? videos;
    const filteredVideos = searchTitle
        ? videosToDisplay.filter((video) => video.title === searchTitle)
        : videosToDisplay;
